<?php
  ...
  <div class="alert" style="text-align: center; font-weight: bold;">
    <span class="closebtn" onclick="this.parentElement.style.display='none';"><a href="fileremover.php" style="text-decoration: none; color: white;">&times;</a></span>
  ...
  if(isset($_POST['submit'])){
    ...
    echo '<form width="400px" action="includes/fileremover.inc.php" method="post">';
